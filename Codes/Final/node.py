...
class Node:
    ...
    def handle_rrep(self, rrep):
        ...
        if self.id == rrep.dest_id:
            self.rreq_state.pop(rrep.src_id, None) #On a réussi à atteindre le noeud, on arrête d'essayer d'envoyer des RREQs
        ...
        rrep.prev_hop = self.id                                         # Mise à jour et relai
